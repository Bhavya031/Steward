...
- Check types may only be: size_under, duration_matches, streams_present, plays, audio_stream_present, loudness_matches, true_peak_under, file_valid, page_count_positive, page_count_matches, text_extractable, format_matches.
